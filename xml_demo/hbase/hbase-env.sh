...
export HBASE_PID_DIR=$HBASE_HOME/logs/pid
...
#export LD_LIBRARY_PATH=$HADOOP_HOME/lib/native:$HADOOP_HOME/lib/native/Linux-amd64-64:/usr/lib64
#export HBASE_LIBRARY_PATH=$HADOOP_HOME/lib/native:$HBASE_HOME/lib/native/Linux-amd64-64:/usr/lib64
