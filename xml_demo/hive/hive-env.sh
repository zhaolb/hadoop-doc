...
#    echo $SERVICE
    if [ "$SERVICE" = "cli" ]; then
         export HADOOP_OPTS=" -XX:NewRatio=12 -Xms300m -Xmx2g -XX:MaxHeapFreeRatio=40 -XX:MinHeapFreeRatio=15 -XX:-UseGCOverheadLimit"
    elif [ "$SERVICE" = "hiveserver2" ];then
       export HADOOP_OPTS="-Xmx4g -Xms1g -Xmn512m -server -XX:+UseConcMarkSweepGC"
